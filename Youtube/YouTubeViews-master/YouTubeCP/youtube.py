...
if __name__ == '__main__':
    ...
    # arguments
    args = ArgumentParser()
    args.add_argument('10',help='The amount of visits ex: 300')
    args.add_argument('https://www.youtube.com/watch?v=LVONKEliDew',help='Youtube videos url list')
    args.add_argument('30',help='Minimum watch time in seconds ex: 38')
