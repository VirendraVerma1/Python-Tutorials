...
d = {'MovieName':li_Name,'Year':li_Year,'Category':li_Category,'Rating':li_Rating,'Image':li_Image,'ScreenShot1':li_ScreenShot1,'ScreenShot2':li_ScreenShot2,'ScreenShot3':li_ScreenShot3,'Trailer':li_trailer,'Description':li_description,'Magnet Link':li_MagnetLink,'Company Size':li_SizeCompany,'Size':li_Size}
df = pd.DataFrame(d)
